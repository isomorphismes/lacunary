#ifndef LACUNARY_CONTINUATION_PATH_H
#define LACUNARY_CONTINUATION_PATH_H

/*
 * Migrated from isomorphismes/analytic-continuation,
 * branch native_convergence_explorer.
 *
 * Historical rational nearest-pole path geometry. This is not germ transport.
 */
